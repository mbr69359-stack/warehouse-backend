...
-- =============================================
-- 补充 ON UPDATE CURRENT_TIMESTAMP（存量库执行一次）
-- =============================================
ALTER TABLE sys_user  MODIFY COLUMN update_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
